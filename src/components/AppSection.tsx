                ...
                <div className="bg-slate-900 rounded-[48px] p-10 md:p-16 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
                    ...
                    <div className="flex-1 relative z-10 text-center md:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                            <button className="flex items-center justify-center gap-3 bg-white text-slate-900 px-6 py-3.5 rounded-xl font-bold hover:bg-gray-100 transition-colors">
                            ...
                            <button className="flex items-center justify-center gap-3 bg-slate-800 text-white border border-slate-700 px-6 py-3.5 rounded-xl font-bold hover:bg-slate-700 transition-colors">
                                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
